...
const getScreenshots = async function (slug) {
  const modalGalleryContainer = document.querySelector(".modal__right");
      ...
      <div class="modal__wrap">
        ...
        <div class="modal__left">
          <div class="modal__details">
            ...
            <div class="modal__details-text-box">
              <p>Age rating</p>
              <p>${game.esrb_rating ? game.esrb_rating.name : "None"}</p>
            </div>
            <div class="modal__details-text-box">
              <p>Website</p>
              <a class="modal__hypertext">${
                game.website ? game.website : "None"
              }</a>
            </div>
          </div>
        </div>
